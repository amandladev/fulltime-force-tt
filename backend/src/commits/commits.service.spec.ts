...
describe('CommitsService', () => {
  ...
  beforeEach(async () => {
    octokitMock = new Octokit() as jest.Mocked<Octokit>;
  ...
  describe('findAll', () => {
    it('should return commits data and format dates', async () => {
      const mockCommits = [
        {
      ...
      const result = await service.findAll({
        username: 'sreyescurotto',
        repository: 'sreyescurotto',
      });
    ...
    it('should throw InternalServerErrorException for other errors', async () => {
      ...
      await expect(
        service.findAll({ username: 'testuser', repository: 'testrepo' }),
